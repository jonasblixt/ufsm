...
static GtkWidget *nav_tree;
static bool nav_tree_visible  = false;
...
void canvas_nav_toggle(void *context)
{
    if (nav_tree_visible) {
        ...
        nav_tree_visible = true;
        gtk_widget_show(nav_tree);
    }
}
...
int main(int argc, char **argv)
{
    ...
    gtk_box_pack_start(GTK_BOX(main_vbox), main_hpane, TRUE, TRUE, 0);
